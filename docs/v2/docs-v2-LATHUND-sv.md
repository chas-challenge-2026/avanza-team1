...
**Regel:** du ska inte kunna paketet utantill. Du ska veta *vilken dörr* du öppnar.

Kursmål och tävling spelar andrafiol. Det här paketet finns för att JS, Java och C++ ska kunna jobba utan att gissa.
...
| Komma ihåg *varför* vi valde X | `10-decision-log.md` |
...
1. Vad är veckans *ett* mål?
2. Vilken issue tar jag?
3. Blockerar jag någon annans kontrakt?
4. Vad kan en lärare se att *jag* gjort på torsdag?

---

## Vad ni *inte* ska göra i möten
